...
def main():
    ...
    qualityIndex  = dataDict['qualityIndex']  #2D quality index of a radar mosaic [0-1]; 1 = best quality
    ...
    mapQI = legs.pal_obj(range_arr=[0.,1.],
                         dark_pos='high',
                         color_arr=pastel,
                         excep_val=[missing],
                         excep_col='grey_120')
    ...
    proj_data = projInds.project_data(qualityIndex)
    
    #plot data & palette
    mapQI.plot_data(ax=ax,data=proj_data, zorder=0,
